...
import { Container, Content, DarkButton, RedButton } from './styles';
...
export function EditDish() {
  ...
  async function handleDelete(id) {
    ...
    try {
      ...
      toast.success(`O prato ${name} removido com sucesso!`, { id: 'deleteDish' });
      navigate('/');
    ...
    <Container>
      ...
      <Content>
        ...
        <div className="buttons">
          ...
          <RedButton onClick={handleSubmit} className="button save" >Salvar alterações</RedButton>
        </div>
        ...
        <Modal isOpen={isModalOpen} close={closeModal}>
          ...
          <div className='buttons'>
            ...
            <RedButton onClick={() => handleDelete(id)}>Excluir</RedButton>
          </div>
        </Modal>
